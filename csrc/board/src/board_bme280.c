...
static BME280_INTF_RET_TYPE _bme280_read(uint8_t reg_addr, uint8_t *reg_data, uint32_t len, void *intf_ptr)
{
    (void)intf_ptr;
...
static BME280_INTF_RET_TYPE _bme280_write(uint8_t reg_addr, const uint8_t *reg_data, uint32_t len, void *intf_ptr)
{
    (void)intf_ptr;
    BME280_INTF_RET_TYPE ret = BME280_E_COMM_FAIL;
