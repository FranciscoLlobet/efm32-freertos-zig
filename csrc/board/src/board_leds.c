...
{
		.port = BOARD_LED_ORANGE_PORT,
		.pin = BOARD_LED_ORANGE_PIN,
		.polarity = SL_SIMPLE_LED_POLARITY_ACTIVE_HIGH
};

sl_simple_led_context_t led_yellow_context =
{
		.port = BOARD_LED_YELLOW_PORT,
		.pin = BOARD_LED_YELLOW_PIN,
		.polarity = SL_SIMPLE_LED_POLARITY_ACTIVE_HIGH
};

sl_led_t led_red =
{
	.context = &led_red_context,
