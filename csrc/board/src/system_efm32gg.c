/**
 * @file
 * @brief CMSIS Cortex-M3 System Layer for
 *EFM32GG devices.
 *******************************************************************************
 * # License
 * <b>Copyright 2022 Silicon Laboratories
...
{
    return (uint8_t)((DEVINFO->PART & _DEVINFO_PART_PROD_REV_MASK) >> _DEVINFO_PART_PROD_REV_SHIFT);
}
 ...
 *clock frequency based on the current
 *   configuration. Assuming that the
 *SystemCoreClock global variable is
 *   maintained, the core clock frequency
 *is stored in that variable as well. This
 *function will however calculate the core
 *clock based on actual HW configuration.
 *It will also update the SystemCoreClock
 *global variable.
 *
 * @note
 *   This is an EFM32 proprietary
 *function, not part of the CMSIS
 *definition.
 *
 * @return
 *   The current core clock frequency in
 *Hz.
 ******************************************************************************/
uint32_t SystemCoreClockGet(void)
{
    ...
    ret >>= (CMU->HFCORECLKDIV & _CMU_HFCORECLKDIV_HFCORECLKDIV_MASK) >> _CMU_HFCORECLKDIV_HFCORECLKDIV_SHIFT;
 ...
 *
 * @return
 *   The maximum core clock frequency in
 *Hz.
 ******************************************************************************/
...
/**
 * @brief
 *   Get high frequency crystal oscillator
 *clock frequency for target system.
 *
 * @note
 *   This is an EFM32 proprietary
 *function, not part of the CMSIS
...
/**
 * @brief
 *   Set high frequency crystal oscillator
 *clock frequency for target system.
 *
 * @note
 *   This function is mainly provided for
 *being able to handle target systems with
 *different HF crystal oscillator
 *frequencies run-time. If used, it should
 *probably only be used once during system
 *startup.
 *
 * @note
 *   This is an EFM32 proprietary
 ...
 *
 * @note
 *   This function is invoked during
 *system init, before the main() routine
 *   and any data has been initialized.
 *For this reason, it cannot do any
...
/**
 * @brief
 *   Get low frequency RC oscillator clock
 *frequency for target system.
 *
 * @note
 *   This is an EFM32 proprietary
 *function, not part of the CMSIS
...
/**
 * @brief
 *   Get ultra low frequency RC oscillator
 *clock frequency for target system.
 *
 * @note
 *   This is an EFM32 proprietary
...
/**
 * @brief
 *   Get low frequency crystal oscillator
 *clock frequency for target system.
 *
 * @note
 *   This is an EFM32 proprietary
...
/**
 * @brief
 *   Set low frequency crystal oscillator
 *clock frequency for target system.
 *
 * @note
 *   This function is mainly provided for
