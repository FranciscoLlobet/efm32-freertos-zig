...
#define UISO_PROTOCOL_MASK                                                                \
    (UISO_PROTOCOL_BIT_MASK | UISO_UDP_SELECTION_BIT_MASK | UISO_TCP_SELECTION_BIT_MASK | \
     UISO_IPV4_IPV6_SELECTION_BIT_MASK | UISO_SECURITY_BIT_MASK)
 ...
 * @return
 */
int miso_create_network_connection(miso_network_ctx_t ctx, const char *host, size_t host_len, uint16_t port,
                                   uint16_t local_port, enum miso_protocol proto);
